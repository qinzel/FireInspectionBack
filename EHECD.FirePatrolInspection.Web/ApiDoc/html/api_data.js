define({ "api": [
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=cmt.add"
      }
    ]
  },
  {
    "description": "<p>说明 appKey：NhTnHhEJc5ZCJM9FfmlCINZDvDfyPzAN appSecret：EpD70oATq6d7TgUoOHkbODQjVg7CUGaWw7thptHPt3KMWLcEN8rWD6V7RjP5fz7a 签名算法：将appKey、appSecret、timestamp、echostr排序后MD5加密</p>",
    "type": "",
    "url": "",
    "version": "0.0.0",
    "filename": "./apidata.js",
    "group": "D__HX______lexiao_git______EHECD_FirePatrolInspection_Web_ApiDoc_apidata_js",
    "groupTitle": "D__HX______lexiao_git______EHECD_FirePatrolInspection_Web_ApiDoc_apidata_js",
    "name": ""
  },
  {
    "success": {
    ...
    "group": "D__HX______lexiao_git______EHECD_FirePatrolInspection_Web_ApiDoc_html_main_js",
    "groupTitle": "D__HX______lexiao_git______EHECD_FirePatrolInspection_Web_ApiDoc_html_main_js",
    "name": ""
  },
  {
    "type": "post",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=tl.add"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=tl.delete"
      }
    ]
  },
  {
    ...
    "success": {
      "examples": [
        {
          "title": "返回信息",
          "content": "{\n    \"success\": true,\n    \"code\": 0,\n    \"message\": \"获取朋友圈帖子详情成功\",\n    \"data\": {\n        \"ID\": 1,                                    //评论ID\n        \"iClientID\": 2,                             //发帖人ID\n        \"sClientName\": \"张三\",                        //发帖人姓名\n        \"sClientImageSrc\": \"https://xxx\",           //发帖人头像\n        \"sTitle\": \"标题\",                             //标题\n        \"sContent\": \"内容\",                           //内容\n        \"sImageSrc\": \"http://xxx,http://xxx\",       //评论图片\n        \"iReplyCount\": 2,                           //评论数\n        \"dCreateTime\": \"2017-10-20T16:50:34.743\",   //发帖时间\n        \"bIsDeleted\": false,                        //删除标识[0:未删除,1:已删除]\n        \"CommentList\": [                            //评论集合\n            {\n                \"ID\": 1,                            //评论ID\n                \"iTieziID\": 1,                      //帖子ID\n                \"iClientID\": 1,                     //评论人ID\n                \"sName\": \"张三\",                    //评论人名称\n                \"sImageSrc\": \"http://xxx\",          //评论人头像\n                \"sTarName\": \"\",                     //目标用户名称\n                \"sContent\": \"看个鸡蛋\",             //评论内容\n                \"iTarClientID\": 0,                  //目标用户ID\n                \"dCreateTime\": \"2018-05-21T13:57:12.27\",//评论时间\n                \"bIsDeleted\": false                 //删除标识[0:未删除,1:已删除]\n            }\n        ]\n    }\n}",
          "type": "json"
        }
      ]
    },
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=tl.get"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=tl.getlist"
      }
    ]
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://114.115.250.165/router/ApiTest?method=tl.getmylist"
      }
    ]
  },
  {
