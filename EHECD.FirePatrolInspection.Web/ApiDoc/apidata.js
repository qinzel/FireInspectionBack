...
/**
@api {post} client.getlist 获取点检员列表
...
/**
@api {post} tl.get 获取朋友圈帖子详情
@apiName tl.get
@apiGroup Timeline

@apiParam {int} iTieziID       帖子ID
...
/**
@api {post} tl.getmylist 获取我的帖子列表
@apiName tl.getmylist
@apiGroup Timeline
...
/**
@api {post} cmt.add 发布评论
@apiName cmt.add
@apiGroup Comment

@apiParam {int} iTieziID        帖子ID
@apiParam {int} iClientID       评论人ID
@apiParam {string} sName        评论人名称
@apiParam {string} sImageSrc    评论人头像
@apiParam {string} sContent     评论内容
@apiParam {int} iTarClientID    评论人目标ID
@apiParam {string} sTarName     评论人目标名称
...
/**
@api {post} unit.getrellist 获取使用单位列表
...
/**
@api {post} device.param 获取新增设备需要的参数
...
/**
@api {post} device.getalllist 获取所有设备
