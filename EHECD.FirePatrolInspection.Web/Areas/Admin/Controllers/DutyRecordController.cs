    ...
    public class DutyRecordController : Controller
    {
        ...
        public void GetExportData()
        {
            ...
            try
            {
                ...
                sHtml.Append("<tr height=\"40\"><td colspan=\"8\" align=\"center\"><b style='font-size: 20px'>值班记录信息</b></td></tr>");
                ...
                for (int i = 0; i < list.Count; i++)
                {
                    ...
                    sHtml.Append("<td style='vnd.ms-excel.numberformat:@'>" + (item.sUnitName == null ? "总平台" : item.sUnitName) + "</td>");
            ...
            {
                ActionLogService.Instance.Add(null, UserSession.GetLogUser().ID, "导出值班记录", exportSuc ? "导出值班记录成功" : "导出值班记录失败");
            }
        }
