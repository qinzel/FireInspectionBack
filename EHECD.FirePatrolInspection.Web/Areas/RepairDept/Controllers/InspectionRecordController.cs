...
namespace EHECD.FirePatrolInspection.Web.Areas.RepairDept.Controllers
{
    ...
    public class InspectionRecordController : Controller
    {
        ...
        public ActionResult GetInsGridData([ModelBinder(typeof(QueryParamBinder))]QueryParams param)
        {
            ...
            return Content(InspectionRecordService.Instance.GetAllTypePartGridData(param));
        }
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public ActionResult GetRepairInsGridData([ModelBinder(typeof(QueryParamBinder))]QueryParams param)
        {
            param.condition.Add("iRecordType", 0);
            LoginUser user = AuthHelper.GetLogRepairUser();
            param.condition.Add("iUnitID", user.iUnitID);
            return Content(InspectionRecordService.Instance.GetAllTypePartRepairDeptGridData(param));
        }
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public ActionResult GetRepairRepairGridData([ModelBinder(typeof(QueryParamBinder))]QueryParams param)
        {
            param.condition.Add("iRecordType", 1);
            LoginUser user = AuthHelper.GetLogRepairUser();
            param.condition.Add("iUnitID", user.iUnitID);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public ActionResult GetRepairChangeGridData([ModelBinder(typeof(QueryParamBinder))]QueryParams param)
        {
            param.condition.Add("iRecordType", 2);
            LoginUser user = AuthHelper.GetLogRepairUser();
            param.condition.Add("iUnitID", user.iUnitID);
        ...
        /// <param name="param"></param>
        /// <returns></returns>
        public ActionResult GetAllTypeListRepairDeptGridData([ModelBinder(typeof(QueryParamBinder))]QueryParams param)
        {
            LoginUser user = AuthHelper.GetLogRepairUser();
            param.condition.Add("iUnitID", user.iUnitID);
            return Content(InspectionRecordService.Instance.GetAllTypePartRepairDeptGridData(param));
        ...
        public void GetExportData(int iRecordType)
        {
            ...
            try
            {
                ...
                //接收需要导出的数据
                List<EHECD_InspectionRecord> list = InspectionRecordService.Instance.GetExportPartRepairDeptList(param).ToList();
                ...
                sHtml.Append("<tr height=\"40\"><td colspan=\"11\" align=\"center\"><b style='font-size: 20px'>" + sTitle + "记录</b></td></tr>");
