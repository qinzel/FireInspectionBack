...
//	            	   			paramsVal.isHourMinute[0]=(function(){
//	            	   				var timestring=_self.trigger.value;
//	            	   				timestring=timestring.split(":")[0].replace(/^0/g,"")*60+(+timestring.split(":")[1].replace(/^0/g,""));
//	            	   				timestring+=paramsVal.space_time;
//	            	   				timestring=[Math.floor(timestring/60),timestring%60];
//	            	   				return [timestring[0]>9?timestring[0]:"0"+timestring[0],timestring[1]>9?timestring[1]:"0"+timestring[1]].join(":")
//
//	            	   			})();
...
//	            	   			paramsVal.isHourMinute[1]=(function(){
//	            	   				var timestring=_self.trigger.value;
//	            	   				timestring=timestring.split(":")[0].replace(/^0/g,"")*60+(+timestring.split(":")[1].replace(/^0/g,""));
//	            	   				timestring-=paramsVal.space_time;
//	            	   				timestring=[Math.floor(timestring/60),timestring%60];
...
$.fn.extend({
	...
	updatedParams: function (json, default_val) {
	    ...
	    if ($(this).attr("time-choice") == "") {
	        ...
	        if (default_val) { $(this).next().val(default_val) }
            console.log(param)
